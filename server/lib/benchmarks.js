...
//   「全産業（合計）」欄、および全業種共通の流動比率の目安）は
//   中小企業庁「令和４年中小企業実態基本調査速報（令和３年度決算実績）」の
//   公表値をそのまま使用。
...
const CURRENT_RATIO_GOOD = 150; // 流動比率の目安(%) - 一般的な財務分析上のガイドライン
const CURRENT_RATIO_BAD = 100;
...
const INDUSTRY_BENCH = {
  ...
  "建設業": {
    ...
    turnover: 1.25, roe: 13.66, equityRatio: 43.67, valueAddedRatio: 25.41
  },
  "製造業": {
    profitMargin: 5.28, productivity: 900.0,
    turnover: 1.06, roe: 9.57, equityRatio: 45.25, valueAddedRatio: 28.31
  },
  "情報通信業": {
    profitMargin: 7.81, productivity: 702.1,
    turnover: 1.04, roe: 10.27, equityRatio: 56.18, valueAddedRatio: 41.44
  },
  "運輸業，郵便業": {
    profitMargin: 2.38, productivity: 680.1,
    turnover: 1.25, roe: 11.44, equityRatio: 34.13, valueAddedRatio: 36.33
  },
  "卸売業": {
    profitMargin: 2.63, productivity: 812.7,
    turnover: 1.80, roe: 11.02, equityRatio: 40.49, valueAddedRatio: 10.65
  },
  "小売業": {
    profitMargin: 2.77, productivity: 743.0,
    turnover: 1.84, roe: 8.00, equityRatio: 32.15, valueAddedRatio: 18.74
  },
  "不動産業，物品賃貸業": {
    profitMargin: 10.27, productivity: 1756.8,
    turnover: 0.34, roe: 14.28, equityRatio: 39.06, valueAddedRatio: 37.63
  },
  "学術研究，専門・技術サービス業": {
    profitMargin: 15.43, productivity: 980.4,
    turnover: 0.51, roe: 6.72, equityRatio: 56.50, valueAddedRatio: 46.82
  },
  "宿泊業，飲食サービス業": {
    profitMargin: 8.86, productivity: 767.1,
    turnover: 1.07, roe: 11.44, equityRatio: 20.16, valueAddedRatio: 47.72
  },
  "生活関連サービス業，娯楽業": {
    profitMargin: 4.13, productivity: 1534.0,
    turnover: 1.09, roe: 6.70, equityRatio: 34.01, valueAddedRatio: 25.26
  },
  "サービス業（他に分類されないもの）": {
    profitMargin: 5.71, productivity: 553.4,
    turnover: 1.26, roe: 12.24, equityRatio: 48.31, valueAddedRatio: 47.74
  }
};

const INDUSTRY_LIST = Object.keys(INDUSTRY_BENCH);

module.exports = { ALL_INDUSTRY_AVG, INDUSTRY_BENCH, INDUSTRY_LIST, CURRENT_RATIO_GOOD, CURRENT_RATIO_BAD };
